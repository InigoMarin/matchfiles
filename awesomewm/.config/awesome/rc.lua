...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " DEV ", " API ", " WEB ", " DOC ", " RDP ", " EMAIL ", " MUS ", " VID ", " PASS " }
...
globalkeys = my_table.join(
	...
	awful.key({ modkey }, "s", function()
		awful.util.spawn("./.dmenu/dmenu-surfraw.sh")
	end, {
		description = "surfraw web search",
		group = "hotkeys",
	}),
	...
	awful.key({ modkey }, "m", function()
		...
		description = "run ncmpcpp",
		group = "hotkeys",
	}),

	-- F Keys
	awful.key({ modkey }, "F1", function()
		awful.spawn(terminal .. " -e lazydocker")
	end, {
		description = "run lazydokeer",
		group = "launcher",
	}),
	awful.key({ modkey }, "F2", function()
		awful.spawn("kodi")
	end, { description = "run kodi", group = "launcher" }),
	awful.key({ modkey }, "F3", function()
		awful.spawn("displayselect")
	end, {
		description = "displayselect",
		group = "launcher",
	}),
	awful.key({ modkey }, "F4", function()
		awful.spawn(terminal .. " -e pulsemixer")
	end, {
		description = "run pulsemixer",
		group = "launcher",
	}),
	...
	awful.key({ modkey }, "F7", function()
		...
		description = "run td-toggle",
		group = "launcher",
	}),
	awful.key({ modkey }, "F12", function()
		awful.spawn(scrlocker)
	end, {
		description = "run screen locker",
		group = "launcher",
	}),

	-- My dmenu scripts (Alt+Ctrl+Key)
	awful.key({ altkey, "Control" }, "e", function()
		awful.util.spawn("./.dmenu/dmenu-edit-configs.sh")
	end, {
		description = "edit config files",
		group = "dmenu scripts",
	}),
	awful.key({ altkey, "Control" }, "m", function()
		awful.util.spawn("./.dmenu/dmenu-sysmon.sh")
	end, {
		description = "system monitoring apps",
		group = "dmenu scripts",
	}),
	...
	awful.key({ altkey, "Control" }, "t", function()
		awful.util.spawn("./.dmenu/dmenu-trading.sh")
	end, {
		description = "trading programs",
		group = "dmenu scripts",
	}),
	...
	awful.key({ modkey }, "Return", function()
		...
		description = "terminal with fish shell",
		group = "super",
	}),
	...
	awful.key({}, "XF86AudioRaiseVolume", function()
		awful.util.spawn("pamixer --allow-boost -i 5")
		beautiful.volume.update()
	end),
	awful.key({}, "XF86AudioLowerVolume", function()
		awful.util.spawn("pamixer --allow-boost -d 5")
		beautiful.volume.update()
	end),
